...
**Disposition:** Consolidated into `CONVENTIONS.md` `conventions.project` local block by **CS33** (PR `CS33`).
...
**Disposition:** Consolidated into `REVIEWS.md` `reviews.project-gates` local block by **CS33** (PR `CS33`).
