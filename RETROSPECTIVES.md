...
2. Run `npx -y github:henrik-me/agent-harness#v0.13.0 lint` to confirm no errors remain.
...
5. After disposition, run `npx -y github:henrik-me/agent-harness#v0.13.0 lint` before opening
   the claim PR.
...
```sh
npx -y github:henrik-me/agent-harness#v0.13.0 lint           # runs the LEARNINGS.md check over the repo
npx -y github:henrik-me/agent-harness#v0.13.0 lint --quiet   # summary only
```
