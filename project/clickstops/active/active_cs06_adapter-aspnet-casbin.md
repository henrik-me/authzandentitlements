...
| Register adapters + verify lite profile | done | yoga-ae-c4 | AddPdp registers aspnet+casbin (default stays reference); no containers; full-solution build 0/0, 367 tests green |
