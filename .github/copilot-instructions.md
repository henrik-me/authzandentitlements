...
Run `npx -y github:henrik-me/agent-harness#v0.1.0 sync --mode=check` (validates your config against the
schema) and `npx -y github:henrik-me/agent-harness#v0.1.0 lint` to confirm conformance before reporting
back.
