...
**Weekly LRN harvest (CS37, 2026-07-04):** LRN-050..064 dispositioned — durable how-tos consolidated into the CONVENTIONS.md/REVIEWS.md project-local blocks and flipped applied; LRN-059/062 confirmed already-landed (CS34 / PR #111); LRN-057 filed as planned CS36 (audit request-snapshot); LRN-035/040 remain deferred (enforcement owned by yoga-ae-c5's CS40).
